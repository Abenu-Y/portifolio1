...
function BackgroundCircles({}: Props) {
  return (
    <motion.div 
       ...
       initial={{opacity:0}}
       animate={{scale:[1,2,2,3,1],opacity:[0.1,0.2,0.4,0.8,1]}}
    ...
    >
          ...
          <div className='absolute border border-[#F7AB0A] rounded-full w-[650px] h-[650px] mt-52 animate-pulse opacity-20' />
